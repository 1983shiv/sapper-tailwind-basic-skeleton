...
>
  <div
    class="lg:px-16 px-6 flex flex-wrap justify-center my-1 px-1 w-full overflow-hidden sm:my-2 sm:px-2 sm:w-full md:my-2 md:px-2 md:w-2/3 lg:my-2 lg:px-2 lg:w-2/3 xl:my-2 xl:px-2 xl:w-2/3"
  >
    <PostList {posts} />
  </div>
  <div
