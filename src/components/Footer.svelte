...
<footer class="text-white bg-gray-50 body-font">
  <div
  ...
  >
    ...
    >
      ...
      <span class="ml-3 text-xl">Webdesign Ninjas</span>
    </a>
    <p
      class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4"
    >
      © 2021 Webdesign Ninjas —
      <a
        href="https://twitter.com/@const_shiv"
        class="text-gray-600 ml-1"
        rel="noopener noreferrer"
        target="_blank">Shiv Srivastava</a
      >
    </p>
    <span
